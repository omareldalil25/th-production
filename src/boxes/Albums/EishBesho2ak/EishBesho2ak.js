...
function EishBesho2ak() {
    ...
    const songs = useMemo(() => [
        { name: 'We Akheeran', image: song1, audio: song1Audio },
        { name: 'We Enta Maaya', image: song2, audio: song2Audio },
        { name: 'Eish Beshoak', image: song3, audio: song3Audio },
        { name: 'Helm Seneen', image: song4, audio: song4Audio },
        { name: 'Kefayak Aazar', image: song5, audio: song5Audio },
        { name: 'Nasseeny Leih', image: song6, audio: song6Audio },
        { name: 'Taman Ekhteyar', image: song7, audio: song7Audio },
        { name: 'Wala Youm Men Ayamo', image: song8, audio: song8Audio },
        { name: 'Ward Senaaey', image: song9, audio: song9Audio },
        { name: 'Lolak Habiby', image: song10, audio: song10Audio },
        { name: 'Kabelteeny', image: song11, audio: song11Audio },
        { name: 'Hekayat El Hob', image: song12, audio: song12Audio },
        { name: '100 Wesh', image: song13, audio: song13Audio },
    ], []);
    ...
    return (
        <div className="EishBesho2ak-page">
            {/* Navbar */}
