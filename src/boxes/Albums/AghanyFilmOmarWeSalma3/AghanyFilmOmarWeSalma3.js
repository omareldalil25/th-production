...
import './AghanyFilmOmarWeSalma3.css';
...
function AghanyFilmOmarWeSalma3() {
    ...
    const songs = useMemo(() => [
        { name: 'Atef W Faten', image: song1, audio: song1Audio },
        { name: 'Gara Eih Ya Einy', image: song2, audio: song2Audio },
        { name: 'Aaletly Nebaead', image: song3, audio: song3Audio },
        { name: 'Noss Lamha', image: song4, audio: song4Audio },
        { name: 'Bent Lazina', image: song5, audio: song5Audio },
    ...
    return (
        <div className="AghanyFilmOmarWeSalma3-page">
            {/* Navbar */}
                ...
                <div className="row">
                    <div className="col-md-12">
                        <div className="album-box-1">
                            ...
                            <h2>Aghany Film Omar We Salma 3</h2>
                        </div>
...
export default AghanyFilmOmarWeSalma3;
