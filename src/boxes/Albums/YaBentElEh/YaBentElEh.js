...
function YaBentElEh() {
    ...
    const songs = useMemo(() => [
        { name: 'Ya Bent El Eh', image: song1, audio: song1Audio },
        { name: 'Makontesh Mebayen', image: song2, audio: song2Audio },
        { name: '3reft Elly Feha', image: song3, audio: song3Audio },
        { name: 'Enta Waheshny', image: song4, audio: song4Audio },
        { name: 'E3tezry', image: song5, audio: song5Audio },
        { name: 'Seeb El Hob', image: song6, audio: song6Audio },
        { name: 'Erga3ly', image: song7, audio: song7Audio },
        { name: 'Hases Bekhouf', image: song8, audio: song8Audio },
        { name: 'Mahadesh Hases Beya', image: song9, audio: song9Audio },
        { name: 'Kol Sana Wenta Tayeb', image: song10, audio: song10Audio },
        { name: 'Soutek', image: song11, audio: song11Audio },
        { name: 'Allah Yebarekly Fek', image: song12, audio: song12Audio },
        { name: 'Ana Wala 3aref', image: song13, audio: song13Audio },
    ], []);
