...
import song8 from './images/song8.jpeg';
import song9 from './images/song9.jpeg';
import song10 from './images/song10.jpeg';
...
function KhaleekFolazy() {
    ...
    const songs = useMemo(() => [
        { name: 'Awelny Kalam', image: song1, audio: song1Audio },
        { name: 'Fagaa Eftaraana', image: song2, audio: song2Audio },
        { name: 'Karahteny Fel Hob', image: song3, audio: song3Audio },
        { name: 'Be Alf Salama', image: song4, audio: song4Audio },
        { name: 'Nafs El Nehaya', image: song5, audio: song5Audio },
        { name: 'Mabatalnash Ehsas', image: song6, audio: song6Audio },
        { name: 'Ad El Foraq', image: song7, audio: song7Audio },
        { name: 'Tamaateeny', image: song8, audio: song8Audio },
        { name: 'Fe Gamal Keda', image: song9, audio: song9Audio },
        { name: 'Ekhteraa', image: song10, audio: song10Audio },
        { name: 'Khaleek Folazy', image: song11, audio: song11Audio },
    ], []);
    ...
    return (
        <div className="KhaleekFolazy-page">
            {/* Navbar */}
