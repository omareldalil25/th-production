...
function Bahebakenta() {
    ...
    const songs = useMemo(() => [
        { name: 'Bahebak Enta', image: song1, audio: song1Audio },
        { name: 'Ya Bakht Elli Hathebeh', image: song2, audio: song2Audio },
        { name: 'Elly Rah', image: song3, audio: song3Audio },
        { name: 'Had Shabaho', image: song4, audio: song4Audio },
        { name: 'Magnoun Ana', image: song5, audio: song5Audio },
        { name: 'Ta3ali Ne3esh', image: song6, audio: song6Audio },
        { name: 'W Men Ba3adi El Tofan', image: song7, audio: song7Audio },
        { name: 'Safha Gededa', image: song8, audio: song8Audio },
        { name: 'Khalina Ekhwat', image: song9, audio: song9Audio },
        { name: 'Habet Etnen', image: song10, audio: song10Audio },
        { name: 'Yareet Terdy', image: song11, audio: song11Audio },
        { name: 'Ghorba', image: song12, audio: song12Audio },
        { name: 'Yaraito Had Yestahel', image: song13, audio: song13Audio },
    ], []);
    ...
    return (
        <div className="Bahebakenta-page">
            {/* Navbar */}
                    ...
                    <div className="col-md-12">
                        ...
                        <div className="mt-4 song-list-container">
                            {songs.map((song, index) => (
                                <div className="song-box d-flex align-items-center mb-3" key={index} style={{ borderBottom: '1px solid #000', paddingBottom: '10px' }}>
                                    <img
                                        src={song.image}
                                        alt={song.name}
                                        style={{
                                    ...
                                    />
                                    <span style={{ flex: '1', fontSize: '18px', color: '#000' }}>{song.name}</span>
