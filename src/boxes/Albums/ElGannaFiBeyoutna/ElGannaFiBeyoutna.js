...
function ElGannaFiBeyoutna() {
    ...
    const songs = useMemo(() => [
        { name: 'Shahr Ramadan', image: song1, audio: song1Audio },
        { name: 'Sahebny Yabouya', image: song2, audio: song2Audio },
        { name: 'Tegy Nensa', image: song3, audio: song3Audio },
        { name: 'Law 3awez El Kher', image: song4, audio: song4Audio },
        { name: 'El Ganna Fi Beyoutna', image: song5, audio: song5Audio },
        { name: 'Ya Arham El Rahemin', image: song6, audio: song6Audio },
        { name: 'Wo Negehna El Sana Di', image: song7, audio: song7Audio },
        { name: 'Yarab Ana Ta3ban', image: song8, audio: song8Audio },
        { name: 'W 3eneha Damma3et', image: song9, audio: song9Audio },
        { name: 'Ana Msh 3aref Atghayar', image: song10, audio: song10Audio },
        { name: 'Sobhan Allah', image: song11, audio: song11Audio },
        { name: 'Asmaa Aallh Al Hosna', image: song12, audio: song12Audio },
    ], []);
    ...
    return (
        <div className="ElGannaFiBeyoutna-page">
            {/* Navbar */}
...
export default ElGannaFiBeyoutna;
