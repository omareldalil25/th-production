...
function OmryEbtada() {
    ...
    const songs = useMemo(() => [
        { name: 'Omry Ebtada', image: song1, audio: song1Audio },
        { name: 'El Hares Allah', image: song2, audio: song2Audio },
        { name: 'Fad Beya', image: song3, audio: song3Audio },
        { name: 'Nafs El Haneen', image: song4, audio: song4Audio },
        { name: 'Ya Aayoon', image: song5, audio: song5Audio },
        { name: 'Habibi Khalas', image: song6, audio: song6Audio },
        { name: 'Batelet Alam Fe Nakad', image: song7, audio: song7Audio },
        { name: 'Ehsasy Mabyekdebsh', image: song8, audio: song8Audio },
        { name: 'Kan Fe Wahda', image: song9, audio: song9Audio },
        { name: 'Ya Baaeed', image: song10, audio: song10Audio },
        { name: 'Kaddab W Anany', image: song11, audio: song11Audio },
        { name: 'Shokran Enak Fe Hayaty', image: song12, audio: song12Audio },
        { name: 'Rehlet El Hayah', image: song13, audio: song13Audio },
        { name: 'Ya Mali Aaeny', image: song15, audio: song15Audio },
        { name: 'Nafs El Haneen (Cover)', image: song14, audio: song14Audio },
    ], []);
