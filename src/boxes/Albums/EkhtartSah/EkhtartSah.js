...
function EkhtartSah() {
    ...
    const songs = useMemo(() => [
        { name: 'Law Hakon Gheir Leek', image: song1, audio: song1Audio },
        { name: 'Ain Shams', image: song2, audio: song2Audio },
        { name: 'Seheit Ala Sotha', image: song3, audio: song3Audio },
        { name: 'Etamen', image: song4, audio: song4Audio },
        { name: 'Lawel Mara', image: song5, audio: song5Audio },
        { name: 'Sweet Melody', image: song6, audio: song6Audio },
        { name: 'Afalt Alby', image: song7, audio: song7Audio },
        { name: 'Yana Ya Mafish', image: song8, audio: song8Audio },
        { name: 'Mestany El Yom', image: song9, audio: song9Audio },
        { name: 'Ya Waheshny', image: song10, audio: song10Audio },
        { name: 'Betsaab Alaya Nafsy', image: song11, audio: song11Audio },
        { name: 'Kam Wahed Fina', image: song12, audio: song12Audio },
        { name: 'Teaarafy', image: song13, audio: song13Audio },
        { name: 'Ekhtart Sah', image: song14, audio: song14Audio },
    ], []);
