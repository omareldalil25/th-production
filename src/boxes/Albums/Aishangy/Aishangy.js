...
function Aishangy() {
    ...
    const songs = useMemo(() => [
        { name: 'Aashaangy', image: song1, audio: song1Audio },
        { name: 'Bood Moaakat', image: song2, audio: song2Audio },
        { name: 'Khadna Manaaa', image: song5, audio: song3Audio },
        { name: 'Mabgesh Bel Tareaa De', image: song4, audio: song4Audio },
        { name: 'Leeh Tallah', image: song3, audio: song6Audio },
        { name: 'Sagel Ya Tarekh', image: song6, audio: song5Audio },
        { name: 'Ahla Kalam', image: song7, audio: song8Audio },
        { name: 'Sawhna', image: song8, audio: song7Audio },
        { name: 'Zay Al Ayam De', image: song9, audio: song9Audio },
    ], []);
