...
function Bahabk() {
    ...
    const songs = useMemo(() => [
        { name: 'Hadalaany ', image: song1, audio: song1Audio },
        { name: 'Wenta Be3eed', image: song2, audio: song2Audio },
        { name: 'Enta Ekhtyar', image: song3, audio: song3Audio },
        { name: 'Hatgawzek ', image: song4, audio: song4Audio },
        { name: 'Habitha Ya Nas', image: song5, audio: song5Audio },
        { name: 'Haytna ', image: song6, audio: song6Audio },
    ], []);
                ...
                <div className="row">
                    <div className="col-md-12">
                        <div className="album-box-1">
                            ...
                            <h2 style={{color:'#181C14'}}>Bahabk</h2>
                        </div>
