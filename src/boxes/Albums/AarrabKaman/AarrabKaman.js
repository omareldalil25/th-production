...
function AarrabKaman() {
    ...
    const songs = useMemo(() => [
        { name: 'Matwaseneesh', image: song1, audio: song1Audio },
        { name: 'Dayeb', image: song2, audio: song2Audio },
        { name: 'Bekelma Netsaleh', image: song3, audio: song3Audio },
        { name: 'Aarrab Kaman', image: song4, audio: song4Audio },
        { name: 'Eskoty', image: song5, audio: song5Audio },
        { name: 'Eftekerly', image: song6, audio: song6Audio },
        { name: 'Ya Ta3ebny', image: song7, audio: song7Audio },
        { name: 'Alby Elly Habbak', image: song8, audio: song8Audio },
        { name: 'Esma W Nassib', image: song9, audio: song9Audio },
        { name: 'Ba3eed 3an 3eny', image: song10, audio: song10Audio },
        { name: 'Heya Di', image: song11, audio: song11Audio },
        { name: 'Ayam Zaman', image: song12, audio: song12Audio },
        { name: 'Rouh Alby', image: song13, audio: song13Audio },
        { name: 'As3ab Ehsas', image: song14, audio: song14Audio },
    ], []);
    ...
    return (
        <div className="AarrabKaman-page">
            {/* Navbar */}
