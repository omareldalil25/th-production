...
function EnayaBethebbak() {
    ...
    const songs = useMemo(() => [
        { name: 'Rayah Balak', image: song1, audio: song1Audio },
        { name: 'Fatet 3alena', image: song2, audio: song2Audio },
        { name: 'Ba3eesh', image: song3, audio: song3Audio },
        { name: 'El Wahida', image: song4, audio: song4Audio },
        { name: 'Mayehremnish Mennak', image: song5, audio: song5Audio },
        { name: 'Enty Elly 3amalty', image: song6, audio: song6Audio },
        { name: 'Rabbena Yewaffa2ek', image: song7, audio: song7Audio },
        { name: 'Ya3ny Khalas', image: song8, audio: song8Audio },
        { name: 'Etla3 Men Doul', image: song9, audio: song9Audio },
        { name: 'Enaya Bethebbak', image: song10, audio: song10Audio },
        { name: 'Kol Marra', image: song11, audio: song11Audio },
        { name: 'Nour Einy', image: song12, audio: song12Audio },
        { name: 'Hawsallek', image: song13, audio: song13Audio },
    ], []);
    ...
    return (
        <div className="EnayaBethebbak-page">
            {/* Navbar */}
