...
function MeenMomkan() {
    ...
    const songs = useMemo(() => [
        { name: 'Meen Momkan', image: song1, audio: song1Audio },
        { name: 'Dana Baba', image: song2, audio: song2Audio },
        { name: 'Kol Dah Ala Aieh', image: song3, audio: song3Audio },
        { name: '180 Darga', image: song4, audio: song4Audio },
        { name: 'Zai Al Nile', image: song5, audio: song5Audio },
        { name: 'Al Ouada Etfakit', image: song6, audio: song6Audio },
        { name: 'Nergaa Tani', image: song7, audio: song7Audio },
        { name: 'Welcome To The Life', image: song8, audio: song8Audio },
        { name: 'Etmany', image: song9, audio: song9Audio },
        { name: 'Fi Al Haiah', image: song10, audio: song10Audio },
        { name: 'Matetghairy Baa', image: song11, audio: song11Audio },
        { name: 'Kol Al Lahgat', image: song12, audio: song12Audio },
    ], []);
