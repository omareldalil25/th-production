...
function HormoneElSaada() {
    ...
    const songs = useMemo(() => [
        { name: 'Hormone ElSaada', image: song1, audio: song1Audio },
        { name: 'Mawahashtekish', image: song2, audio: song2Audio },
        { name: 'Hawwa', image: song5, audio: song3Audio },
        { name: 'Maalish', image: song4, audio: song4Audio },
        { name: 'Msh Hatghyar 3shn Had', image: song3, audio: song6Audio },
        { name: 'Mawdoa Rogoana', image: song6, audio: song5Audio },
        { name: 'Wala Yehmek', image: song7, audio: song8Audio },
        { name: '30 Hayah', image: song8, audio: song7Audio },
        { name: 'Tag', image: song9, audio: song9Audio },
    ], []);
    ...
    return (
        <div className="hormone-el-saada-page">
            {/* Navbar */}
