...
function Hob() {
    ...
    const songs = useMemo(() => [
        { name: 'Arrab Habiby', image: song1, audio: song1Audio },
        { name: 'Hob', image: song2, audio: song2Audio },
        { name: 'Lamma Betkoun Ba3eed', image: song3, audio: song3Audio },
        { name: 'Enty Nesity Nafsek', image: song4, audio: song4Audio },
        { name: 'El Wehda Bete2telny', image: song5, audio: song5Audio },
        { name: 'Har2et Dam', image: song6, audio: song6Audio },
        { name: 'Forsa Akhira', image: song7, audio: song7Audio },
        { name: 'Enta Hayati', image: song8, audio: song8Audio },
        { name: 'Awseflak', image: song9, audio: song9Audio },
        { name: 'Lessa Bahebbak', image: song10, audio: song10Audio },
        { name: 'Yana Yana', image: song11, audio: song11Audio },
        { name: 'Olly Bahebbak', image: song12, audio: song12Audio },
        { name: 'Mehtaglik Yamma', image: song13, audio: song13Audio },
    ], []);
