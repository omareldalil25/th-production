...
function HaeeshHayati() {
    ...
    const songs = useMemo(() => [
        { name: 'Koll Elly Fat', image: song1, audio: song1Audio },
        { name: 'Taaba Koll El Nas', image: song2, audio: song2Audio },
        { name: 'Ya Habibi Shoof', image: song3, audio: song3Audio },
        { name: 'Haeesh Hayati', image: song4, audio: song4Audio },
        { name: 'W Ahlam Leih', image: song5, audio: song5Audio },
        { name: 'Bagheer Aleiha', image: song6, audio: song6Audio },
        { name: 'Enta Mesheit', image: song7, audio: song7Audio },
        { name: 'Hagat Keteir', image: song8, audio: song8Audio },
        { name: 'Khontek Embareh', image: song9, audio: song9Audio },
        { name: 'Hayati Fadak', image: song10, audio: song10Audio },
        { name: 'Rasmy Fahmy Nazmy', image: song11, audio: song11Audio },
        { name: 'Taala Ergaa Tany', image: song12, audio: song12Audio },
        { name: 'Beinak W Beiny', image: song13, audio: song13Audio },
        { name: 'Howa Fein', image: song14, audio: song14Audio },
        { name: 'Come Back To Me', image: song15, audio: song15Audio },
    ], []);
    ...
    return (
        <div className="HaeeshHayati-page">
            {/* Navbar */}
