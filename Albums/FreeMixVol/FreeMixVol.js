...
function FreeMixVol() {
    ...
    const songs = useMemo(() => [
        { name: 'Law Kont Nesit', image: song1, audio: song1Audio },
        { name: 'Hagat 3allemtahalek', image: song2, audio: song2Audio },
        { name: 'La Ensa', image: song3, audio: song3Audio },
        { name: 'Rahet Habibty', image: song4, audio: song4Audio },
        { name: 'Habiby Wenta Be3eed', image: song5, audio: song5Audio },
        { name: 'Law Khayfa', image: song6, audio: song6Audio },
    ], []);
